...
interface CustomTextProps {
    variant?: Variant
    fontFamily?: "Okra-Regular" | "Okra-Bold" | "Okra-Light" | "Okra-Medium";
    fontSize?: number
    color?: string;
...
const CustomText: FC<CustomTextProps> = ( {
    ...
    if ( variant && fontSizeMap[ variant ] ) {
        const defaultSize = fontSizeMap[ variant ][ Platform.OS as PlatformType ]; computedFontSize = RFValue( fontSize || defaultSize );
    ...
    return <Text
        ...
        onLayout={ onLayout }
        style={ [ styles.text, fontFamilyStyle, { fontSize: computedFontSize, color: color || Colors.text, }, style ] }
        { ...props }
    >{ children }</Text>
